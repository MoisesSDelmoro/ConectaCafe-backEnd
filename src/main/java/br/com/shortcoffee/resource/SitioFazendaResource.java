...
//        return ResponseEntity.ok(sitioFazendaService.save(sitioFazenda));
    ...
    public ResponseEntity<SitioFazenda> editSitioFazenda(@PathVariable("id") Long sitioFazendaId, @RequestBody SitioFazenda sitioFazenda) throws SitioFazendaException {
        return ResponseEntity.ok(sitioFazendaService.editSitioFazenda(sitioFazendaId, sitioFazenda));
    }
}
